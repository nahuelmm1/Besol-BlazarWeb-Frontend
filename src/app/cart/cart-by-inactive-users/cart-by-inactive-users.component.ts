...
import { CartByInactiveUsersColumns } from './cart-by-inactive-users-columns';
const PAGE_KEY = 'cartByInactiveUsers';

@Component({
  moduleId: module.id,
  templateUrl: 'cart-by-inactive-users.component.html'
})
export class CartByInactiveUsersComponent implements OnInit {
  ...
  constructor(
              ...
              private cartSelectorColumns: CartByInactiveUsersColumns,
