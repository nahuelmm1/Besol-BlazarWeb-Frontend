...
@Component({
  selector: 'app-checkout-open',
  templateUrl: './open.checkout.component.html',
  styleUrls: ['./open.checkout.component.scss'],
  host: {
    '[@routeAnimation]': 'true'
  },
  animations: [ routeAnimation ]
})
export class CheckoutOpenComponent implements OnInit {
